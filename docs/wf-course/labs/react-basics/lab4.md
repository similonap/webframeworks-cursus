import LaboStateOmHooglaag from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-counter/App';
import LaboStateKleurkiezer from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-color-picker/App';
import LaboStateContactForm from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-contact-form/App';
import LaboStateInputField from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-shared-inputs/App';
import LaboStateCheckbox from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-visibility-toggle/App';
import LaboStateGoods from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-goods/App';
import LaboStateLoading from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-loading-indicator/App';
import LaboStateRandomCat from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-random-cat/App';
import Joske from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-joske/App';
import CodeSandbox from '@site/src/components/CodeSandbox/CodeSandbox';
import Maaltafels3 from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-maaltafels/App';
import PenguinListState from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-penguin-gallery/App';
import SimpleQuiz from '@site/src/components/lab-solutions/lab-state-basic/lab-state-basic-simple-quiz/App';
